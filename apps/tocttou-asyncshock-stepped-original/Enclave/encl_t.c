...
{
	CHECK_REF_POINTER(pms, sizeof(ms_ecall_checker_thread_t));
	//
	// fence after pointer checks
	//
	sgx_lfence();
	ms_ecall_checker_thread_t* ms = SGX_CAST(ms_ecall_checker_thread_t*, pms);
	sgx_status_t status = SGX_SUCCESS;



	ms->ms_retval = ecall_checker_thread();
